...
#define CLIENT_ID "d:k2s0nq:ArduinoUno:ictCA_sp01"
#define MS_PROXY "k2s0nq.messaging.internetofthings.ibmcloud.com"
#define AUTHTOKEN "34*rb(+L?qq!q?o!9C"
// Update these with values suitable for your network.
//byte mac[] = { 0x00, 0xAA, 0xBB, 0xCC, 0xDE, 0x03 };
byte mac[] = { 0x1C, 0xCA, 0xFE, 0xCA, 0xFE, 0xCA };
